...
void change_cpu_freq()
{
	...
	value |= BF_POWER_VDDDCTRL_TRG(30); /*change to 1.475v - 27 */
	...
	value |= BF_CLKCTRL_FRAC_CPUFRAC(19); // 22
	value &= ~BM_CLKCTRL_FRAC_CLKGATECPU;

	HW_CLKCTRL_FRAC_WR(value); /*Change cpu to 261.82Mhz*/
