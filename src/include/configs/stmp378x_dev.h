...
#define CONFIG_SYS_MEMTEST_START 0x40010000	/* memtest start address */
#define CONFIG_SYS_MEMTEST_END	 0x42000000	/* 16MB RAM test */
#define CONFIG_NR_DRAM_BANKS	1		/* we have 1 bank of DRAM */
#define CONFIG_STACKSIZE	(256*1024)	/* regular stack */
#define PHYS_SDRAM_1		0x40000000	/* DDR Start */
...
#define CONFIG_IPADDR		10.1.184.112	//192.168.0.136
#define CONFIG_SERVERIP		10.1.184.188	//192.168.0.2
...
#define CONFIG_BOOTARGS		"console=ttyAM0,115200n8 "\
			"ssp1=spi1 ssp2=gpmi lcd_panel=tvenc_pal ubi.mtd=1 root=ubi0:rootfs rootfstype=ubifs"
...
#define CONFIG_KS8851_SNL_SPI_BUS	0
#define CONFIG_KS8851_SNL_SPI_CS	0
